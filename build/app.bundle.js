        ...
        value: function format(obj) {
            ...
            if (obj) {
                for (var property in obj) {
                    var validation = obj[property] && _typeof(obj[property] !== 'function');
                ...
                if (formattedMessage.length > NO_OF_TRAIL_CHARACTERS) {
                    formattedMessage = formattedMessage.substr(START_INDEX, formattedMessage.length - NO_OF_TRAIL_CHARACTERS);
                }
            }
...
var _formatutils = __webpack_require__(59);

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var Order = function () {
    function Order(orderId, orderDate, orderCost) {
...
var _internetcustomer = __webpack_require__(121);

var _order2 = __webpack_require__(86);

var _arrowfunctions = __webpack_require__(118);

var _withoutpromises = __webpack_require__(123);

var _withpromise = __webpack_require__(124);

var PromiseWorkers = _interopRequireWildcard(_withpromise);
...
var customer = new _internetcustomer.InternetCustomer(10, "Jatin", "Gurgaon", 10000, true, "http://jatin.myblog.com");

console.log(customer.format());
console.log(customer instanceof _internetcustomer.InternetCustomer);

var customerCSVString = '10,JK,India,1000,true';
var anotherCustomer = _internetcustomer.InternetCustomer.createCustomer(customerCSVString);

anotherCustomer.addOrder(new _order2.Order(1, new Date(), 1000));
anotherCustomer.addOrder(new _order2.Order(2, new Date(), 2000));
anotherCustomer.addOrder(new _order2.Order(3, new Date(), 3000));
anotherCustomer.addOrder(new _order2.Order(4, new Date(), 4000));
anotherCustomer.addOrder(new _order2.Order(5, new Date(), 5000));
...
var promiseWorker1 = new PromiseWorkers.HeavyPromiseWorker();
var promiseWorker2 = new PromiseWorkers.HeavyPromiseWorker2();
var input = 200;
...
// reject 2
Promise.all([promiseWorker1.doHeavyWork(input), promiseWorker2.doHeavyWork(input)]).then(function (data) {
    return console.log("Both successfully completed ... " + JSON.stringify(data));
}, function (error) {
    return console.log("One of the worker failed ... " + JSON.stringify(error));
});
...
var Customer = function () {
    ...
    _createClass(Customer, [{
        ...
        value: function createCustomer(csvString) {
            ...
            if (csvString) {
                var splittedString = csvString.split(COL_SEPARATOR);

                customer = new (Function.prototype.bind.apply(Customer, [null].concat(_toConsumableArray(splittedString))))();
            }
...
var customer = (_customer = {
    id: id,
    name: name
}, _defineProperty(_customer, '_Prop' + licenseKey, 100), _defineProperty(_customer, 'work', function work() {
    return 'Success';
}), _customer.__proto__ = new Customer(), _customer);
...
var _customer = __webpack_require__(119);
...
var InternetCustomer = function (_Customer) {
    ...
    _createClass(InternetCustomer, [{
        key: 'format',
        value: function format() {
            return _formatutils.ObjectFormatter.format(this).toUpperCase();
        }
    }]);
...
function processOrder(order) {
    ...
    if (order.ammount >= 1000) console.log("Order status: PROCESSED");else console.log('Order status: ON-HOLD');
...
processOrder = new Proxy(processOrder, {
    ...
    apply: function apply(target, currentHandler, args) {
        var alreadyProcessedOrders = ['ORD101', 'ORD10101', 'ORD1023'];

        console.log('Proxying started');

        var orderId = args[0].id;
        ...
        if (alreadyProcessedOrders.isExist(orderId)) {
            ...
            var status = target.apply(undefined, _toConsumableArray(args));
        ...
        value: function doHeavyWork(input, callback) {
            setTimeout(function () {
                ...
                if (typeof callback === 'function') {
                    callback({
                        status: status //enhanced object literals
                    });
                }
            }, DEFAULT_TIMEOUT);
        }
...
var HeavyPromiseWorker = function () {
    function HeavyPromiseWorker() {
        _classCallCheck(this, HeavyPromiseWorker);
    }

    _createClass(HeavyPromiseWorker, [{
        key: 'doHeavyWork',
        value: function doHeavyWork(input) {
    ...
    return HeavyPromiseWorker;
}();

var HeavyPromiseWorker2 = function () {
    function HeavyPromiseWorker2() {
        _classCallCheck(this, HeavyPromiseWorker2);
    }

    _createClass(HeavyPromiseWorker2, [{
        key: 'doHeavyWork',
        value: function doHeavyWork(input) {
            var workerPromise = new Promise(function (resolve, reject) {
                //call async operation here
    ...
    return HeavyPromiseWorker2;
}();

exports.HeavyPromiseWorker = HeavyPromiseWorker;
exports.HeavyPromiseWorker2 = HeavyPromiseWorker2;
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(12)(proto, TO_PRIMITIVE, __webpack_require__(128));
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(115), __webpack_require__(307)(module)))
